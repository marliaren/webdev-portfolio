...
// get month year certificate is acquired, name of org, and link of the credentials
  ...
  return (
    <div className={styles.educContainer}>
      ...
      <div className={styles.textContainer}>
        <span className={styles.dateYear}>{dateYear}</span>
        <h5 className={styles.orgCertification}>{orgCertification}</h5>
        <a
          className={styles.certCredentials}
          target="_blank"
          href={certCredentials}
        >
          {certCredentials}
        </a>
      </div>
